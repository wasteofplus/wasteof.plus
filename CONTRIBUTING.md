...
1. [Developing an Addon](#developing-an-addon)
   ...
   a. [Chrome.Storage API](#chrome-storage-api)
   b. 
...
- `addon.json` - The addon.json object contains the following properties:
  ...
  - enabledByDefault - Boolean: whether the extension should be enabled by default. If set to false, the extension will have to be enabled by the user. Extensions that provide basic or core functionalities should have this property set to true.
