function updateOptions (card, showing) {
  if (showing) {
    ...
    card.querySelector('.optionsExpand').src =
      '../../assets/icons/material-icons/expand_less.svg'
  } else {
    card.querySelector('.addonOptions').style.display = 'none'
    card.querySelector('.optionsExpand').src =
      '../../assets/icons/material-icons/expand_more.svg'
  }
  return !showing
}
    ...
    if (result[addon + 'Options'] === undefined) {
      ...
      for (const otherOption of sortedOptionsArray) {
        if (otherOption.dynamicVisibility !== undefined) {
          ...
          if (
            otherOption.dynamicVisibility.find((rule) => rule.id === option)
          ) {
            console.log(
            ...
            if (
              otherOption.dynamicVisibility
                .find((rule) => rule.id === option)
                .values.includes(result[addon + 'Options'][option])
            ) {
              console.log(
                'showing an option, ',
                otherOption.id,
              ...
              optionsParentElement.children[indexOfOtherOption].style.display =
                'none'
              console.log(
                'evaluating dependencies recursively for option',
                otherOption.id,
...
fetch('templates/extensionCard.html')
            ...
            for (const addon of data.sort(addonSorter)) {
              fetch('../addons/' + addon + '/addon.json')
                ...
                .then(async (addonData) => {
                  ...
                  card.querySelector('.addonDescription').innerText =
                    ...
                    card
                      ...
                      .insertAdjacentHTML(
                        ...
                        '<a class="developer-link" href="' +
                          developer.link +
                          '"><img class="inline developer-logo" src="' +
                          developer.link +
              ...
              <div class="addonOption inline-flex" role="group">
                ...
                <button type="button" class="firstOption px-3 py-2 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                  None
                </button>
                <button type="button" class="lastOption px-3 py-2 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                  Discord
                </button>
                </div>
              </div>`
              ...
              <input type="text" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    if (option.type === 'boolean') {
                      card
                        ...
                        .insertAdjacentHTML('beforeend', booleanOptionText)
                      card
                        .querySelector('.addonOptions')
                      ...
                      card
                        .querySelector('.addonOptions')
                        .lastElementChild.querySelector('.optionBoolean')
                        .addEventListener('change', (event) => {
                      ...
                      card
                        .querySelector('.addonOptions')
                        .insertAdjacentHTML('beforeend', selectOptionText)
                      const addedElement =
                        card.querySelector('.addonOptions').lastElementChild
                      addedElement.querySelector('.optionName').innerText =
                        option.name
                      ...
                      card
                        .querySelector('.addonOptions')
                        .insertAdjacentHTML('beforeend', fileOptionText)
                      ...
                      card
                        .querySelector('.addonOptions')
                        .insertAdjacentHTML('beforeend', sliderOptionText)
                      const addedElement =
                        card.querySelector('.addonOptions').lastElementChild
                      addedElement.querySelector('.optionName').innerText =
                        option.name
                      addedElement.querySelector('input').min =
                        option.settings.min
                      addedElement.querySelector('input').max =
                        option.settings.max
                      addedElement.querySelector('input').step =
                        option.settings.step
                      addedElement.querySelector('input').value =
                        await getOptionValue(option.id, addon)
                      addedElement
                        .querySelector('input')
                      ...
                      card
                        .querySelector('.addonOptions')
                        .insertAdjacentHTML('beforeend', textOptionText)
                      const addedElement =
                        card.querySelector('.addonOptions').lastElementChild
                      addedElement.querySelector('.optionName').innerText =
                        option.name
                      addedElement.querySelector('input').value =
                        await getOptionValue(option.id, addon)
                      addedElement.querySelector('input').placeholder =
                        option.placeholder
...
chrome.storage.local.get(['popupTheme']).then((result) => {
  ...
  if (
    result.popupTheme === 'dark' ||
    (result.popupTheme === undefined &&
